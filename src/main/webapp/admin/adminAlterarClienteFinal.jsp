         ...
         <div class="wrap-login100">
            <div class="login100-pic">
               ...
               <form action="../ServletAdminExcluirConta" method="post">
                  <button type='submit' name = 'numConta' value = '<%= request.getParameter("numConta") %>' onclick="return confirm('Tem certeza que deseja excluir a conta?')" class="login100-form-btn">
                  Excluir Conta
                  </button>
               </form>
               <br/><br/><br/><br/>
            ...
            <form class="login100-form" action="../ServletAdminAlterarConta" method="post">
               ...
               <div class="wrap-input100">
                  <input class="input100" type="text" name="NomeCompleto" id="txt_firstCapital" oninput="nomeCompleto()" placeholder="Digite o Nome Completo" required>
               ...
               <div class="wrap-input100">
                  <input class="input100" type="text" name="EndCadastro"  id="txt_firstCapitalendereco" oninput="endereco()" id="txt_firstCapital" oninput="nomeCompleto()" placeholder="Digite o Endereço" required>
                  <span class="focus-input100"></span>
               </div>
               <br/><br/>
