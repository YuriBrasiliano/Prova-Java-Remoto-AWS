...
<br/><br/><br/>Alterar Dados do Cliente<br/><br/> É necessário ter uma conta cadastrada!<br/></span>
        ...
        try {
            Connection conexao = ConnectionFactory.getConnection();
		      ...
		      out.println("<table border='2' align= 'center'><tr><th align= 'center'>Alterar Dados</th><th align= 'center'>Número da Conta</th><th width='500px' align= 'center'>Nome do Cliente</th><th align= 'center'>Data de Nascimento do Cliente</th><th align= 'center'>CPF do Cliente</th><th align= 'center'>Endereço do Cliente</th></tr>");
            while (resultado.next()) {
                ...
                out.println("<tr><td align= 'center'> <form action='adminAlterarClienteFinal.jsp' method='post'><button type='submit' name='numConta' value='"+coluna1+"' class='login100-form-btn'>Alterar Dados</button></form></td><td align= 'center'>"+ coluna1 + "</td><td align= 'center'>" + coluna2 + "</td><td align= 'center'>" + coluna3 + "</td><td align= 'center'>" + coluna4 + "</td><td align= 'center'>" + coluna5 + "</td></tr>");
            }
